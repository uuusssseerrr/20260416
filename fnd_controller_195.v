...
module fnd_controller (
    input clk,
    input rst,
    input [13:0] fnd_in, //counter_10000
    output [3:0] fnd_com,
    output [7:0] fnd_data
);
...
module clk_div_1khz (
        ...
        always @(posedge clk, posedge rst) begin
            if (rst) begin
                counter_reg <= 10'd0; //16
                o_1khz_reg <= 1'b0;
            end else begin
                counter_reg <= counter_reg + 1; //65000까지
                if (counter_reg == 5_000-1 ) begin // 50_000
                    counter_reg <= 10'd0; //16
...
module digit_splitter (
    input  [13:0] digit_in, //counter_10000
    output [3:0] digit_1,
    output [3:0] digit_10,
